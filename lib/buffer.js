...
module.exports = function bufferSplit(cache, encoding, delimiter) {
  ...
  delimiter = $util.isString(delimiter) ? new Buffer(delimiter, encoding || 'utf8') : delimiter;
  assert(Buffer.isBuffer(delimiter), '[bufferSplit]Invalid delimiter, should be a buffer!given: ' + delimiter);
